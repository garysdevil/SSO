...
func test4GetRoleByUser() {

	user := model.User{
		UserID: "btgp4o7aisehpj533alg",
	}
	fmt.Println(user.GetRolesByUser(user))
}

// func test3UserGroupRelate() {
// 	user := model.User{
// 		UserID: "btc61mvaiselrk46100g",
// 		Groups: []model.Group{
// 			{GroupID: "btgbjlvaisegm86fb9eg"},
// 		},
// 	}
// 	user.UserGroupRelate()
// }
